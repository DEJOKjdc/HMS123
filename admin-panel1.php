<!DOCTYPE html>
<?php 
$con=mysqli_connect("localhost","root","shreevishnu@1","myhmsdb");
...
// Replace all script blocks with this single one at the bottom of the file, before </body>
<script>
$(document).ready(function() {
    ...
    // Fix clickDiv function
    window.clickDiv = function(id) {
        // Fix the href/id mismatch
        const tabId = id.replace('#app-hist', '#list-pat')
                       .replace('#list-app', '#list-app')
                       .replace('#list-pres', '#list-pres')
                       .replace('#list-settings', '#list-settings');
    ...
    if (window.location.hash) {
        const hash = window.location.hash.replace('#app-hist', '#list-pat');
...
// Update these links in the dashboard section
<p class="links cl-effect-1">
    <a href="#list-doc" onclick="clickDiv('#list-doc-list')">
        View Doctors
    </a>
...
<div class="tab-pane fade" id="list-doc" role="tabpanel" aria-labelledby="list-home-list">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <a href="#list-dash" onclick="clickDiv('#list-dash-list')" class="btn btn-primary" style="margin-bottom: 20px;">
